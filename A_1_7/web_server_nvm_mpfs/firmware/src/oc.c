...
callback_PWM_Reset_OC callback_PWM_Reset_OC_fp = NULL;

void register_callback_PWM_Reset_OC(callback_PWM_Reset_OC ptr_callback_PWM_Reset_OC)
{
    callback_PWM_Reset_OC_fp = ptr_callback_PWM_Reset_OC;
}
...
void __ISR(_OUTPUT_COMPARE_1_VECTOR, ipl7auto) Oc1ISR() {
    if (callback_PWM_Reset_OC_fp != NULL){
        callback_PWM_Reset_OC_fp();
    }
    //PORTAbits.RA15 = 0;
