...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_OC5, OUTPUT_PIN_RPB8 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_OC4, OUTPUT_PIN_RPA15 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_U1TX, OUTPUT_PIN_RPD11 );
