...
//register function
//OC1callbackflag will return 1 when callback function is called
void OC_register_OC1callback(OC1callback ptr_OC1callback) { 
    OC1callbackfp = ptr_OC1callback; 
    OC1callbackflag = 1; 
} 

//Interrupt service routine of the OC channel
